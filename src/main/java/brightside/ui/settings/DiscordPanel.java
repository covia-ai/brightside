...
/**
 * The <b>Discord</b> integration: the assistant as a bot the owner can message
 * from anywhere. The token is stored encrypted and the bot is created live; the
 * allow-list says who may talk to it.
 */
@SuppressWarnings("serial")
public final class DiscordPanel extends SettingsPage {
